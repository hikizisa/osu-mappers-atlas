...
import { Database, Globe2, LocateFixed, MapPinned } from 'lucide-react'
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_22rem] lg:items-stretch">
        <div className="atlas-map-stage">
          <div className="atlas-map-stage-header">
            <div>
              <p className="atlas-kicker mb-1">mapper signal map</p>
            ...
            <div className="atlas-map-status" style={{ borderColor: selectedTone }}>
              ...
              {formatNumber(selectedCountry.mapperCount || 0)} indexed
            </div>
          </div>
          ...
          <div className="atlas-world-map" aria-busy={isLoadingCountries}>
            <ComposableMap
              ...
              projectionConfig={{ scale: 158, center: [4, 10] }}
              ...
              <Geographies geography={worldCountries}>
                {({ geographies }) =>
                  geographies.map(geo => {
                    ...
                    const fill = country ? mapperTone(country.mapperCount || 0) : '#e6edf6'
                    ...
                    return (
                      <Geography
                        ...
                        aria-label={country ? `${countryLabel(country)}, ${country.mapperCount || 0} mappers indexed` : geo.properties?.name}
                        onClick={() => {
                        ...
                        fill={fill}
                        stroke={isSelected ? '#0f172a' : 'rgba(255,255,255,0.72)'}
        ...
        <aside className="atlas-map-sidebar" aria-live="polite">
          <div className="atlas-map-sidebar-head">
            ...
            <div className="min-w-0">
              <p className="atlas-kicker mb-1">selected country</p>
          ...
          <div className="atlas-map-rank">
            <p className="atlas-kicker mb-3">largest indexed scenes</p>
